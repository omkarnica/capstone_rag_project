"""
Clean Docling filing JSON and convert it into Pinecone-ready chunks.
...
Chunking flow:
    ...
    Docling JSON
      ...
      |-- extract_structured_table_chunks()
      |-- semantic_blocks_to_chunks()
      |-- is_low_value_chunk()
      `-- should_keep_chunk()

Primary output:

    List[{"id", "text", "metadata"}] suitable for RAPTOR and Pinecone.
"""
